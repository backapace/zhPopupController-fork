...
//
//  Created by yuchen on 2016/11/15.
//  Copyright © 2017年 yuchen-z. All rights reserved.
//
...
- (void)keyboardWillChangeFrame:(NSNotification*)notification {
    ...
    //duration   暂时取消动画 因第三方键盘引起的多次动画会导致坐标有问题。
    {
        if (keyboardHeight > 0 && keyboardRect.size.height > 0) {
